...
*/
      ...
      ps.printf("Qom a Rainfall Hydrologic Model (" + QomVer_ + ") \n");
      ps.printf("this is a simple model of losses and excesses \n");
      ps.printf("Clark a Runoff Model  \n");
      ps.printf("Qom-Clark a rainfall-runoff model"); ps.println();
