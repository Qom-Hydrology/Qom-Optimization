...
/**
 * Class representing problem the Qom hydrological model for the calculation of losses and excesses.
 */
public class QomModel extends AbstractDoubleProblem {
  ...
  public QomModel(String qomDataFile) {
    line_ = 0;
